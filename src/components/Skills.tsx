        ...
        >
          {dict.categories.map((cat, index) => (
            <StaggerItem key={cat.category}>
              <div className="neo-card p-4 sm:p-6 h-full">
                <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-5">
                  <span
                    className={`${colorList[index % colorList.length]} border-2 sm:border-3 border-neo-border rounded-lg sm:rounded-xl w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center text-lg sm:text-xl shadow-[2px_2px_0px_0px_#1a1a1a] sm:shadow-[3px_3px_0px_0px_#1a1a1a]`}
                  >
