      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid md:grid-cols-[2fr_1fr] gap-6 sm:gap-8">
          ...
          <FadeInLeft delay={0.1}>
            <div className="neo-card p-5 sm:p-6 md:p-8 space-y-3 sm:space-y-4">
          ...
          >
            <StaggerItem>
              <ScaleIn delay={0.2}>
                <div className="neo-card p-3 sm:p-5 bg-neo-yellow text-center md:text-left">
            ...
            <StaggerItem>
              <ScaleIn delay={0.35}>
                <div className="neo-card p-3 sm:p-5 bg-neo-pink text-center md:text-left">
            ...
            <StaggerItem>
              <ScaleIn delay={0.5}>
                <div className="neo-card p-3 sm:p-5 bg-neo-green text-center md:text-left">
